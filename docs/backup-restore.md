...
Kontrak rinci evolusi tersebut berada pada [spesifikasi alokasi kategori transaksi](transaction-allocations.md), [spesifikasi Anggaran v1](budgets.md), dan rancangan [Tujuan Keuangan v1](financial-goals.md).
